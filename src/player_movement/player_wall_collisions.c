...
int detect_wall_collision_north(t_cub_data *cub_data, double get_player_radian, int player_moving)
{
	...
	if (player_moving == 1 && treat_wall_collision_quadrant_one_north(cub_data, next_y, next_x))
		return (1);
	if (player_moving == 2 && treat_wall_collision_quadrant_two_north(cub_data, next_y, next_x))
		return (1);
	if (player_moving == 3 && treat_wall_collision_quadrant_three_north(cub_data, next_y, next_x))
		return (1);
	if (player_moving == 4 && treat_wall_collision_quadrant_four_north(cub_data, next_y, next_x))
		return (1);
	return (0);
}
...
int detect_wall_collision_south(t_cub_data *cub_data, float get_player_radian, int player_moving)
{
	...
	if (player_moving == 1 && treat_wall_collision_quadrant_one_south(cub_data, next_y, next_x))
		return (1);
	if (player_moving == 2 && treat_wall_collision_quadrant_two_south(cub_data, next_y, next_x))
		return (1);
	if (player_moving == 3 && treat_wall_collision_quadrant_three_south(cub_data, next_y, next_x))
		return (1);
	if (player_moving == 4 && treat_wall_collision_quadrant_four_south(cub_data, next_y, next_x))
		return (1);
	return (0);
}
