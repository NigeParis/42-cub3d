...
/*   Updated: 2024/11/28 10:46:20 by nrobinso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			put_img_textures_vertical(t_cub_data *cub_data, \
				int *line_start_pixels_ptr, int line_stop_pixels, \
				int strip_index);
...
void			reset_values_end_loop(t_data *map_data, \
				int *offset_x, int *offset_y);
void			get_map_check_and_setup(int argc, char **argv, \
				t_data *map_data, t_cub_data *cub_map);
...
double			calibrate_angle_for_radian(t_cub_data *cub_data, \
...
unsigned int	get_img_color(t_cub_data *cub_data, int wall_face, \
				int x, int y);
...
int				detect_wall_collision_north(t_cub_data *cub_data, \
				double get_player_radian, int player_facing);
int				detect_wall_collision_south(t_cub_data *cub_data, \
				float get_player_radian, int player_facing);
