...
/*   Updated: 2024/11/25 16:41:22 by nrobinso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_line_loop(t_data *map_data, t_draw_line_data *line_data, \
		double angle_radian);
int		draw_dot(t_data *map_data);
int		check_dot(t_data *map_data);
int		calculate_dot_size(t_data *map_data);
void	draw_radar_line(t_data *map_data, \
...
void	reset_values_after_horizontal_loop(int *horizontal_ptr, \
		int *vertical_ptr);
void	reset_values_after_vertical_loop(t_data *map_data, \
		int *offset_x, int *vertical_ptr, int *char_ind_ptr);
void	draw_lines(t_data *map_data, int *offset_x, \
		int *offset_y, char *line);
