...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   treat_movement_east.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: rchourak <rchourak@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/25 15:51:16 by rchourak          #+#    #+#             */
/*   Updated: 2024/11/25 15:56:23 by rchourak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_move_east_key_values(t_cub_data *cub_data)
{
	...
	cub_data->player_cub.player_angle = calibrate_angle_for_radian
